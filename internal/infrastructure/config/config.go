...
func loadCachePrefixes() CachePrefixes {
	return CachePrefixes{
		...
		DeviceRemember:        envStringOrDefault("DEVICE_REMEMBER_CACHE_KEY", "device_remember_token_"),
		Device:                envStringOrDefault("DEVICE_CACHE_KEY", "device_token_"),
		Product:               envStringOrDefault("PRODUCT_CACHE_PREFIX", "product_cache_prefix_"),
...
func loadCacheTags() CacheTags {
	return CacheTags{
		...
		Store:            envStringOrDefault("STORE_CACHE_KEY_", "STORE_CACHE_KEY_"),
	}
}
